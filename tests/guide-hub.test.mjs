...
test('guide hub promotes the most recently verified retail guides first', async () => {
  ...
  assert.ok(latest.includes('href="/proxima/"'));
  assert.ok(latest.includes('href="/steam-features-single-player-cloud/"'));
  assert.ok(latest.includes('href="/dungeon-exploration-guide/"'));
});
