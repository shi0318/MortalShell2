...
export const SITE = {
  ...
  description:
    'Independent Mortal Shell II wiki with source-tracked guides for Open Beta, release date, Shells, bosses, map, and systems. Every fact carries a confirmation status.',
  locale: 'en',
  ...
  steamStandardPriceUsd: '\.99',
  steamDevoutPriceUsd: '\.99',
